...
const colleges = [
  ...
  },
  {
    ...
    desc: ['（描述）'],
    mentors: [
      { name: '贾宝玉', gender: '男', photo: '/导师图片/贾宝玉.webp', desc: '毕业于大观书院，现系从前书院美术学院教授，主修书法，个人十余岁为古建筑题字牌匾，书法作品收到政治高层赞扬和求取。据说家里很有钱，周末会直升机往返书院和家，所以周末好像不怎么用加练。' },
      { name: '林黛玉', gender: '女', photo: '/导师图片/林黛玉.webp', desc: '毕业于金陵书院，现系从前书院美术学院教授，主修美术鉴赏，现已担任国际艺术展特邀评委四十余次。喜画文风骨和明朝文物。但是林老师好像不太喜欢学生带发钗和点冷香。' }
    ]
  },
  {
    name: '文学学院',
